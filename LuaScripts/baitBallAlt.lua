...
function baitBall(angle, position, center, centerVector, agent)
	...
	-- @gamefromscratch (24 November 2012). GAMEDEV MATH RECIPES: ROTATING ONE POINT AROUND ANOTHER POINT [online]. [Accessed 2016]. 
	-- Available from: <http://www.gamefromscratch.com/post/2012/11/24/GameDev-math-recipes-Rotating-one-point-around-another-point.aspx>.
